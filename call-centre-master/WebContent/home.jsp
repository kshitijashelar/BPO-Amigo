					...
					<div class="chit-chat-layer1">
						<div class="col-md-12 chit-chat-layer1-left">
							<div class="work-progres">
								<div class="chit-chat-heading">Recent Add Call Info.</div>
											   ...
											   if(calls.size() == 0){
												   %>
											           <tr class="alert alert-danger">
												           <td colspan="4">Not find records</td>
											            </tr>	   
												   <%
											   }else{
												   int count = 1;
												   ...
												   %>
												     <tr>
												         ...
												         <td><% if (call.getAudioFilePath() == null){out.print("--");}else{out.print(call.getAudioFilePath());} %></td>
