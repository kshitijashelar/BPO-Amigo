					...
					<div class="chit-chat-layer1">
						<div class="col-md-12 chit-chat-layer1-left">
							<div class="work-progres">
								<div class="chit-chat-heading">Test text call data</div>
								<!-- <div class="table-responsive"> -->
									...
									<form class="form-horizontal" action="./AddCall" method="post">
										...
										<div class="form-group">
											...
											<div class="col-xs-5">
												<textarea rows="" cols="" class="form-control"
													name="call_data_text" placeholder="Enter call text data..."
													required="" onkeypress="return isParagraphWriter(event)"></textarea>
											</div>
										</div>
										<div class="form-group">
